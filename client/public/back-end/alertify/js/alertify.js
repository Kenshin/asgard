...
(function (global, undefined) {
	...
	Alertify = function () {
		...
		dialogs = {
			buttons : {
				holder : "<div class=\"modal-footer\">{{buttons}}</div>",
				submit : "<button type=\"submit\" class=\"alertify-button alertify-button-ok\" id=\"alertify-ok\">{{ok}}</button>",
				ok     : "<button type=\"button\" class=\"btn btn-primary contol-button-height\" id=\"alertify-ok\">{{ok}}</button>",
				cancel : "<button type=\"button\" class=\"btn contol-button-height\" id=\"alertify-cancel\">{{cancel}}</button>"
			},
